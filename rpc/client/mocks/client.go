...
// BridgeCommitment provides a mock function with given fields: ctx, start, end
func (_m *Client) BridgeCommitment(ctx context.Context, start uint64, end uint64) (*coretypes.ResultBridgeCommitment, error) {
	ret := _m.Called(ctx, start, end)

	var r0 *coretypes.ResultBridgeCommitment
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64, uint64) (*coretypes.ResultBridgeCommitment, error)); ok {
		return rf(ctx, start, end)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64, uint64) *coretypes.ResultBridgeCommitment); ok {
		r0 = rf(ctx, start, end)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*coretypes.ResultBridgeCommitment)
		}
	}
...
// BridgeCommitmentInclusionProof provides a mock function with given fields: ctx, height, txIndex, start, end
func (_m *Client) BridgeCommitmentInclusionProof(ctx context.Context, height int64, txIndex int64, start uint64, end uint64) (*coretypes.ResultBridgeCommitmentInclusionProof, error) {
	ret := _m.Called(ctx, height, txIndex, start, end)

	var r0 *coretypes.ResultBridgeCommitmentInclusionProof
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, int64, uint64, uint64) (*coretypes.ResultBridgeCommitmentInclusionProof, error)); ok {
		return rf(ctx, height, txIndex, start, end)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64, int64, uint64, uint64) *coretypes.ResultBridgeCommitmentInclusionProof); ok {
		r0 = rf(ctx, height, txIndex, start, end)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*coretypes.ResultBridgeCommitmentInclusionProof)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, int64, int64, uint64, uint64) error); ok {
		r1 = rf(ctx, height, txIndex, start, end)
	} else {
		r1 = ret.Error(1)
	}
